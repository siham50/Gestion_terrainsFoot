...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $result = $controller->forgotPassword($email);
...
<head>
    ...
    <title>Mot de passe oublié - Foot Fields</title>
    <style>
        * {
            margin: 0;
            padding: 0;
    ...
    <div class="container">
        ...
        <div class="card">
            ...
            <?php if (!empty($message)): ?>
                <div class="<?php echo (strpos($message, '✅') !== false || strpos($message, 'Si votre email existe') !== false) ? 'success' : 'error'; ?>">
                    <?php echo $message; ?>
                </div>
            <?php endif; ?>
